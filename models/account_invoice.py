...
class QRCodeInvoice(models.Model):
    ...
    partner_vat = fields.Char(string='Partner Tax ID', help="The Partner Tax Identification Number.", related='partner_id.vat', store=True)
    ...
    total_discount_amount = fields.Monetary(string='Discount Amount', compute='_get_discount_amount', store=True, tracking=True)
